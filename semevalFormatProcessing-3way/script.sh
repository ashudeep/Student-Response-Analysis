#!/bin/bash
#rm -f answers.csv
./extractBaselineFeatures.sh -m 3way ../../semeval2013-Task7-5way/beetle/train/Core/ > beetleBaselineFeatures.arff;
./extractBaselineFeatures.sh -m 3way ../../semeval2013-Task7-5way/beetle/test-unseen-answers/Core/ > beetleTestBaseline5way-UA.arff;
./extractBaselineFeatures.sh -m 3way ../../semeval2013-Task7-5way/beetle/test-unseen-questions/Core/ > beetleTestBaseline5way-UQ.arff;
...
./evaluation.sh -mode 3way beetleTestBaseline5way-UA.txt testGold-UA.txt
cd -
...
cd ../evaluationScripts
./evaluation.sh -mode 3way beetleTestBaseline5way-UQ.txt testGold-UQ.txt
