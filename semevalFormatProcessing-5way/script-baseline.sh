#!/bin/bash
#rm -f answers.csv
./extractBaselineFeatures.sh ../../semeval2013-Task7-5way/beetle/train/Core/ > beetleBaselineFeatures.arff;
./extractBaselineFeatures.sh ../../semeval2013-Task7-5way/beetle/test-unseen-answers/Core/ > beetleTestBaseline5way-UA.arff;
./extractBaselineFeatures.sh ../../semeval2013-Task7-5way/beetle/test-unseen-questions/Core/ > beetleTestBaseline5way-UQ.arff;
